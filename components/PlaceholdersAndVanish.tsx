  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full text-white bg-zinc-900 disabled:bg-zinc-800 transition duration-200 flex items-center justify-center"
      >
        <IoIosExpand />
      </button>
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className=" text-sm sm:text-base font-normal text-neutral-200 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate"
            >
